...
class BrowserAgent(BaseBrowserAgent):
    ...
    def __init__(self, execution_mode='text', enable_gif=True, case_name=None, wallet_context=None):
        ...
        super().__init__(execution_mode='text', enable_gif=enable_gif, case_name=case_name, wallet_context=wallet_context)
...
def run_ai_task_sync(task_description: str, planned_tasks=None, callback=None, should_stop=None, execution_mode='text', wallet_context=None):
    agent = BrowserAgent(execution_mode='text', wallet_context=wallet_context)
...
def run_full_process_sync(task_description: str, analysis_callback=None, step_callback=None, should_stop=None, execution_mode='text', enable_gif=True, case_name=None, wallet_context=None):
