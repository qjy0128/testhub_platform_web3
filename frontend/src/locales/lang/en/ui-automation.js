export default {
  ...
  ai: {
    ...
    walletModeEnabled: 'Enabled',
    walletModeDisabled: 'Disabled',
    walletModeTip: 'The first release only supports MetaMask on EVM chains.',
    walletProvider: 'Wallet Provider',
    walletProviders: {
      metamask: 'MetaMask'
    },
    walletTargetChain: 'Target Chain',
    walletTargetChainPlaceholder: 'For example: Ethereum Mainnet / Sepolia / Polygon',
    walletForceCloseExistingChrome: 'Close Existing Chrome Before Run',
    walletChains: {
    ...
    walletMessages: {
      providerRequired: 'Please select a wallet provider first',
      targetChainRequired: 'Please enter a target chain first'
    },
    startExecution: 'Start Execution',
