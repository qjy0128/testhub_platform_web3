export default {
  ...
  ai: {
    ...
    walletMode: '钱包模式',
    walletModeEnabled: '已启用',
    walletModeDisabled: '未启用',
    walletModeTip: '当前首版仅支持 MetaMask 的 EVM 链钱包模式。',
    walletProvider: '钱包提供方',
    walletProviders: {
      metamask: 'MetaMask'
    },
    walletTargetChain: '目标链',
    walletTargetChainPlaceholder: '例如：Ethereum Mainnet / Sepolia / Polygon',
    walletForceCloseExistingChrome: '执行前关闭现有 Chrome',
    walletChains: {
    ...
    walletMessages: {
      providerRequired: '请先选择钱包提供方',
      targetChainRequired: '请先填写目标链'
    },
    startExecution: '开始执行',
    stopExecution: '停止执行',
    saveAsCase: '保存为用例',
